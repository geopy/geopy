...
"""
Documentation for API: https://www.geocodefarm.com/dashboard/documentation/

Examples JSON response for geocode (as of 3/12/2014):
{
    "geocoding_results": {
        "LEGAL_COPYRIGHT": {
        ...
        "ACCOUNT": {
            "name": "Scrubbed Data",
            "email": "scrubbed_data@example.com",
            "api_key": "aaaabbbbbccccccddddddeeeeeee",
            "monthly_due": "0.00",
            "next_due": "NEVER",
        ...
        "COORDINATES": {
            "latitude": "45.2043888297258",
            "longitude": "-93.4001462313338"
        },
        "STATISTICS": {
            "load_time": "0.15",
...
Examples JSON response for reverse (as of 3/12/2014):
{
    "geocoding_results": {
        "LEGAL_COPYRIGHT": {
            "copyright_notice": "Copyright (c) 2013 Grabenhofen Corporation (Colorado, USA) - All Rights Reserved.",
